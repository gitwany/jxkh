package com.wuhan.sp.common.constant;
...
public class CommonConstants {
    ...
    public static final String CONTEXT_KEY_DEPTCODE = "currentDeptCode";
    ...
    public static final String JWT_KEY_DEPTCODE = "deptcode";
}
