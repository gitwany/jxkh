package com.wuhan.sp.common.context;
...
public class BaseContextHandler {
    ...
    public static String getDeptcode(){
        Object value = get(CommonConstants.CONTEXT_KEY_DEPTCODE);
        return returnObjectValue(value);
    }
    ...
    public static void setDeptcode(String deptcode){
        set(CommonConstants.CONTEXT_KEY_DEPTCODE,deptcode);
    }
    ...
    public static class UnitTest {
        ...
        public void testSetUserInfo(){
            ...
            BaseContextHandler.setUsercode("test2");
            assertEquals(BaseContextHandler.getUsercode(), "test2");
        }
    }
}
