...
public class JWTHelper {
    ...
    public static String generateToken(IJWTInfo jwtInfo, String priKeyPath, int expire) throws Exception {
        String compactJws = Jwts.builder()
                ...
                .claim(CommonConstants.JWT_KEY_DEPTCODE, jwtInfo.getDeptcode())
    ...
    public static IJWTInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
        ...
        return new JWTInfo(body.getSubject(),
                ...
                StringHelper.getObjectValue(body.get(CommonConstants.JWT_KEY_USERNAME)),
                StringHelper.getObjectValue(body.get(CommonConstants.JWT_KEY_DEPTCODE))
        );
    }
    /**
     * 获取token中的用户信息
